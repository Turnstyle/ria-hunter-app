...
export async function GET(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const result = {
      ...
      main_addr_city: profile.main_addr_city || profile.main_office_location?.city || null,
      main_addr_state: profile.main_addr_state || profile.main_office_location?.state || null,
      main_addr_zip: profile.main_addr_zip || profile.main_office_location?.zipcode || null,
      main_addr_country: profile.main_addr_country || profile.main_office_location?.country || 'United States',
