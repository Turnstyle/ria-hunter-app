    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-2xl mx-auto mb-6 sm:mb-8">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p>Click on any <span className="font-semibold text-blue-600">RIA name</span> in your search results to view their detailed profile with personal research tools - add notes, tags, and save links!</p>
              </div>
            </div>
          </div>
        </div>
